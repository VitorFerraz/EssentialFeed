...
final class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didStartLoading_displayNoErrorMessage_andStartsLoadings() {
    ...
    func test_didFinishLoadingWithError_diplayErrorAndStopsLoading() {
        let (sut, view) = makeSUT()
    ...
    func test_didFinishLoadingWithMapperError_diplayLocalizedErrorMessageAndStopsLoading() {
        let (sut, view) = makeSUT(mapper: { resource in
            throw anyNSError
        })

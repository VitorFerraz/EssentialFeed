//
//  EssentialFeedTestsAPIEndToEndTests.swift
//  EssentialFeedTestsAPIEndToEndTests
//
//  Created by Vitor Ferraz Varela on 23/08/22.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file _: StaticString = #file, line _: UInt = #line) -> Swift.Result<[FeedImage], Error>? {
